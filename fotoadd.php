<?php
/**
 * Onde vai ser feita a adição de fotos do usuário que foi logado
 * 
 * @package ATV3
 * @access private 
 * @var string $msg recebe a variavel global @global string $_POST['texto']
 */
function add(){
    $msg=(isset($_POST['texto']))? $_POST['texto']:NULL;
 ...
 */
        ...
        <div id='menu' class='ui secondary pointing menu'>
            ...
            echo "<div class='ui middle aligned center aligned grid'>
                <div class='column'>
                    <form class='ui large form' action='ProcessaI.php' method='post' enctype='multipart/form-data' >
                    <div class='ui stacked segment'>
                        ...
                        <div class='ui left icon input'>
                            ...
                            <textarea type='text' name='texto' placeholder='Digite algo sobre a imagem...' required></textarea>
                        </div>
                        </div>
